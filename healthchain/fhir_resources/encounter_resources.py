...
class Encounter_ParticipantModel(BaseModel):
    ...
    type_field: List[CodeableConceptModel] = Field(
        default_factory=list,
        alias="type",
...
class Encounter_ReasonModel(BaseModel):
    id_field: stringModel = Field(
        default=None,
        alias="id",
        description="Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.",
    ...
    use_field: List[CodeableConceptModel] = Field(
        default_factory=list,
        alias="use",
    ...
    value_field: List[CodeableReferenceModel] = Field(
        default_factory=list,
        alias="value",
...
class Encounter_DiagnosisModel(BaseModel):
    id_field: stringModel = Field(
        default=None,
        alias="id",
        description="Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.",
    ...
    condition_field: List[CodeableReferenceModel] = Field(
        default_factory=list,
        alias="condition",
...
class Encounter_AdmissionModel(BaseModel):
    id_field: stringModel = Field(
        default=None,
        alias="id",
        description="Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.",
    ...
    preAdmissionIdentifier_field: IdentifierModel = Field(
        default=None,
        alias="preAdmissionIdentifier",
        description="Pre-admission identifier.",
    )
    origin_field: ReferenceModel = Field(
        default=None,
        alias="origin",
        description="The location/organization from which the patient came before admission.",
    )
    admitSource_field: CodeableConceptModel = Field(
        default=None,
        alias="admitSource",
        description="From where patient was admitted (physician referral, transfer).",
    )
    reAdmission_field: CodeableConceptModel = Field(
        default=None,
        alias="reAdmission",
    ...
    destination_field: ReferenceModel = Field(
        default=None,
        alias="destination",
        description="Location/organization to which the patient is discharged.",
    )
    dischargeDisposition_field: CodeableConceptModel = Field(
        default=None,
...
class Encounter_LocationModel(BaseModel):
    id_field: stringModel = Field(
        default=None,
        alias="id",
        description="Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.",
    ...
    location_field: ReferenceModel = Field(
        default=None,
        alias="location",
    ...
    form_field: CodeableConceptModel = Field(
        default=None,
        alias="form",
...
class EncounterModel(BaseModel):
    ...
    class_field: List[CodeableConceptModel] = Field(
        default_factory=list,
        alias="class",
    ...
    priority_field: CodeableConceptModel = Field(
        default=None,
        alias="priority",
    ...
    serviceType_field: List[CodeableReferenceModel] = Field(
        default_factory=list,
        alias="serviceType",
    ...
    subjectStatus_field: CodeableConceptModel = Field(
        default=None,
        alias="subjectStatus",
    ...
    episodeOfCare_field: List[ReferenceModel] = Field(
        default_factory=list,
        alias="episodeOfCare",
    ...
    careTeam_field: List[ReferenceModel] = Field(
        default_factory=list,
        alias="careTeam",
    ...
    participant_field: List[Encounter_ParticipantModel] = Field(
        default_factory=list,
        alias="participant",
        description="The list of people responsible for providing the service.",
    )
    appointment_field: List[ReferenceModel] = Field(
        default_factory=list,
        alias="appointment",
        description="The appointment that scheduled this encounter.",
    )
    # virtualService_field: List[VirtualServiceDetailModel] = Field(default_factory=list, alias="virtualService", description="Connection details of a virtual service (e.g. conference call).")
    actualPeriod_field: PeriodModel = Field(
        default=None,
        alias="actualPeriod",
    ...
    reason_field: List[Encounter_ReasonModel] = Field(
        default_factory=list,
        alias="reason",
        description="The list of medical reasons that are expected to be addressed during the episode of care.",
    )
    diagnosis_field: List[Encounter_DiagnosisModel] = Field(
        default_factory=list,
        alias="diagnosis",
        description="The list of diagnosis relevant to this encounter.",
    )
    account_field: List[ReferenceModel] = Field(
        default_factory=list,
        alias="account",
        description="The set of accounts that may be used for billing for this Encounter.",
    )
    dietPreference_field: List[CodeableConceptModel] = Field(
        default_factory=list,
        alias="dietPreference",
        description="Diet preferences reported by the patient.",
    )
    specialArrangement_field: List[CodeableConceptModel] = Field(
        default_factory=list,
    ...
    specialCourtesy_field: List[CodeableConceptModel] = Field(
        default_factory=list,
    ...
    admission_field: Encounter_AdmissionModel = Field(
        default=None,
        alias="admission",
        description="Details about the stay during which a healthcare service is provided.",
    )
    location_field: List[Encounter_LocationModel] = Field(
        default_factory=list,
        alias="location",
