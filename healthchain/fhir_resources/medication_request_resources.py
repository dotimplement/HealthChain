...
class Dosage_DoseAndRateModel(BaseModel):
    ...
    doseRange_field: RangeModel = Field(
...
class DosageModel(BaseModel):
    ...
    maxDosePerLifetime_field: QuantityModel = Field(
        default=None,
...
class MedicationRequestModel(BaseModel):
    ...
    requester_field: ReferenceModel = Field(
        default=None,
        alias="requester",
    ...
    performerType_field: CodeableConceptModel = Field(
        default=None,
        alias="performerType",
    ...
    courseOfTherapyType_field: CodeableConceptModel = Field(
        default=None,
