...
class TestFHIRVersionManager:
    """Tests for FHIRVersionManager class."""
    ...
    def test_set_fhir_version(self):
    ...
    def test_get_resource_class_caching(self):
    ...
    def test_get_resource_class_cache_cleared_on_version_change(self):
    ...
    def test_get_resource_class_invalid_resource(self):
    ...
    def test_version_context_nesting(self):
    ...
    def test_version_context_invalid_version(self):
    ...
    def test_version_context_with_resource_loading(self):
...
class TestModuleLevelFunctions:
    ...
    def test_get_fhir_version(self):
...
class TestSupportedVersions:
    """Tests for supported versions constants."""
