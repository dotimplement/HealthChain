...
from healthchain.fhir.version import FHIRVersionManager


class TestVersioningIntegration:
    """Integration tests for version management across the library."""

    def setup_method(self):
        """Reset version before each test."""
        FHIRVersionManager._instance = None

    def test_create_condition_with_different_versions(self):
    ...
    def test_create_bundle_with_different_versions(self):
    ...
    def test_create_patient_with_different_versions(self):
    ...
    def test_bundle_operations_with_versioned_resources(self):
    ...
    def test_version_persistence_across_function_calls(self):
    ...
    def test_top_level_api_consistency(self):
    ...
    def test_create_medication_statement_with_versions(self):
    ...
    def test_version_switching_workflow(self):
    ...
    def test_element_helpers_with_versions(self):
    ...
    def test_readers_with_versions(self):
...
class TestVersionContextIntegration:
    """Integration tests for version context manager."""

    def setup_method(self):
        """Reset version before each test."""
        FHIRVersionManager._instance = None

    def test_version_context_with_resource_creation(self):
    ...
    def test_nested_version_contexts(self):
